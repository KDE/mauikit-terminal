...
/**
 * @brief A widget which displays output from a terminal emulation and sends input keypresses and mouse activity to the terminal.
 *
 ...
 *
 * @note This class is not part of any public API, and its usage is restricted via the QML exposed type `QMLTermWidget`
 */
...
public:
    ...
    /**
     * @brief Returns the number of lines of text which can be displayed in the widget.
     *
